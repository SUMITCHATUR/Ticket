...
const SeatGridAllAvailable = ({ seats, selectedSeat, onSeatSelect, loading, routeId }) => {
  const handleSeatSelect = (seat) => {
    ...
    // Allow selection of ALL seats - no restrictions
    onSeatSelect(seat)
  }
  ...
  // Get seat styling based on selection only (all seats are available)
...
export default SeatGridAllAvailable
