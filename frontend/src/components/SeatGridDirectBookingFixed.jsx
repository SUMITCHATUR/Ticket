...
const SeatGridDirectBookingFixed = ({ seats, selectedSeat, onSeatSelect, loading, routeId }) => {
  const handleSeatSelect = (seat) => {
    ...
    // Allow selection of any seat - no restrictions
    onSeatSelect(seat)
...
export default SeatGridDirectBookingFixed
